...
const extended_cmtat_single_asset_mligo_json_1 = __importDefault(require("../compiled/extended_cmtat_single_asset.mligo.json"));
...
function main() {
    ...
    "name":"CMTAT_TEST",
    "description":"Example CMTA Token implementation (using @ligo/cmtat library from LIGO registry)",
    "version":"0.1.0",
    "license":{"name":"MIT"},
    "authors":["Frank Hillard<frank.hillard@gmail.com>"],
    "homepage":"",
    "source":{"tools":["Ligo"], "location":"https://github.com/frankhillard/CMTAT_ligo_example"},
    "interfaces":["TZIP-012"],
    "errors":[],
    "views":[]
