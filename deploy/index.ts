...
import singleAssetContract from "../compiled/extended_cmtat_single_asset.mligo.json";
...
async function main() {
  ...
  token_info.set("name", char2Bytes("FINAL_CMTAT_EXAMPLE"));
  token_info.set("description", char2Bytes("My custom extended CMTA Token (single asset)"));
  token_info.set("symbol", char2Bytes("FRK"));
  token_info.set("decimals", char2Bytes("0"));
  token_info.set("ISIN", char2Bytes("US4242424242"));
